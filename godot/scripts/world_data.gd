...
const NPCS_TEMPLATE := [
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 12, "grid": [3, 4], "row_label": "Hen",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 6, "grid": [2, 3], "row_label": "Feeding",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 20, "grid": [4, 5], "row_label": "Row",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 8, "grid": [4, 2], "row_label": "Hen",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 6, "grid": [3, 2], "row_label": "Patient",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 12, "grid": [4, 3], "row_label": "Pot",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 12, "grid": [3, 4], "row_label": "Fence",
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 12, "grid": [4, 3], "row_label": "Hinge",
