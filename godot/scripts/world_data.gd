...
const NPCS_TEMPLATE := [
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 12, "grid": [3, 4],
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 6, "grid": [2, 3],
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 20, "grid": [4, 5],
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 8, "grid": [4, 2],
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 6, "grid": [3, 2],
	...
	},
	{
		...
		"exercises": [
			...
			{"phase": 3, "mode": "array", "answer": 12, "grid": [4, 3],
