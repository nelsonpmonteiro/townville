...
const farmCollisionMap: Tile[][] = [
  ...
  // Row 1
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 2 (buildings: henhouse 4-5, stable 14-15, barn 24-25)
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 3
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 4 (event points: mae 5, chester 15, lily 25)
  ['#','#','#','#','#','.','#','#','#','#','#','#','#','#','#','.','#','#','#','#','#','#','#','#','#','.','#','#','#','#'],
  // Row 5
  ['#','#','#','#','#','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','#','#'],
  // Row 6
  ['#','#','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','#','#'],
  // Row 7 (event points: joe 5, rose 25)
  ['#','#','#','#','#','.','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','.','#','#','#','#'],
  // Row 8 (buildings: coop 4-5, clinic 13-14, garden 24-25)
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 9 (event point: vera 15 + spawn 14)
  ['#','#','#','#','#','.','#','#','#','#','#','#','#','#','.','.','#','#','#','#','#','#','#','#','#','.','#','#','#','#'],
  // Row 10
  ['#','#','#','#','#','.','#','#','#','#','#','#','#','#','.','#','#','#','#','#','#','#','#','#','#','.','#','#','#','#'],
  // Row 11
