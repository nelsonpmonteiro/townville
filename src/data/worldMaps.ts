...
// Generated from logical-mosaic-w1.png pixel sampling (dirt path color calibration)
// With manual overrides for event points, spawn, and building footprints
const farmCollisionMap: Tile[][] = [
  // Row 0
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 1
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 2 (henhouse at 3,2; stable at 13,2; barn at 23,2)
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  ...
  // Row 7
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','.','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 8 (coop at 3,8; animal clinic at 13,8; garden at 23,8)
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 9 (event points at 5,9; 15,9; 22,9 + spawn at 14,9)
  ['#','#','#','#','#','.','#','#','#','#','#','#','#','#','.','.','#','#','#','#','#','#','.','#','#','#','#','#','#','#'],
  // Row 10
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','.','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 11
  ...
  // Row 18
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','.','.','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
  // Row 19 (farm gate exit at 15,19)
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','.','.','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
];
...
export const WORLD_1_FARM: WorldMap = {
  ...
  eventPoints: [
    ...
    { id: 'ep_billy_1', npcId: 'billy', x: 14, y: 12 },
  ],
  buildings: [
    // World 1 buildings - all pending assets, using placeholders
    // Per HERMES-rendering-spec.md §3.2
