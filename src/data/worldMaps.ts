...
const farmCollisionMap: Tile[][] = [
  ...
  ['#','.','.','#','#','.','.','.','.','.','.','.','.','.','#','#','.','.','.','.','.','.','.','#','#','.','.','.','.','.'],
  // Row 9 (event points at 5,9; 15,9; 22,9 + spawn at 13,9)
  ['#','.','.','#','#','E','.','.','.','.','.','.','.','.','S','E','.','.','.','.','.','.','.','#','#','E','.','.','.','#'],
  // Row 10
  ['#','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','#'],
  // Row 11
  ['#','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','#'],
  // Row 12 (event point Billy at 14,12)
  ['#','.','.','.','.','.','.','.','.','.','.','.','.','.','E','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.'],
  // Row 13
  ['#','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','#'],
  // Row 14
  ...
  // Row 18
  ['#','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','.','#'],
  // Row 19 (farm gate exit at 14,19)
  ['#','#','#','#','#','#','#','#','#','#','#','#','#','#','X','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'],
];
...
export const WORLD_1_FARM: WorldMap = {
  ...
  eventPoints: [
    ...
    { id: 'ep_joe_1', npcId: 'farmer-joe', x: 22, y: 3 },
    { id: 'ep_lily_1', npcId: 'lily', x: 5, y: 9 },
